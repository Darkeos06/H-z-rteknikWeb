...
const getServiceCategoriesSitemap = unstable_cache(
  async () => {
    ...
    // Create sitemap entries for each location and category combination
...
export async function GET() {
  const sitemap = await getServiceCategoriesSitemap()
