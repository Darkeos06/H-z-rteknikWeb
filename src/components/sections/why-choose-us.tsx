...
import { ShieldCheck, Award, Users, Wrench, Clock, CheckCircle2, Sparkles, Building2 } from 'lucide-react'
...
export function WhyChooseUs({ image, content, features }: WhyChooseUsProps) {
  const stats = [
  ...
  return (
    <section className="w-full bg-slate-950 text-white py-16 md:py-24 border-b border-stone-800 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-1/3 h-96 w-96 rounded-full bg-blue-600/10 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-1/3 h-96 w-96 rounded-full bg-emerald-500/10 blur-3xl pointer-events-none" />
      ...
      <div className="container max-w-screen-xl mx-auto px-4 md:px-6 relative z-10 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tight">
            Çeyrek Asırlık Mühendislik & Güven Standartlarımız
          </h2>
          <p className="text-stone-300 text-sm md:text-base leading-relaxed">
            Ankara genelinde 25 yılı aşkın süredir bireysel ve endüstriyel tesisat, iklimlendirme ve yapı projelerinde sıfır hata prensibi ile çalışıyoruz.
          </p>
        </div>

        {/* 4 Stats Cards Grid from Image 1 */}
